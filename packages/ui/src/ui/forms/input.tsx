    ...
    return (
      ...
      >
        <input
          ...
          data-slot="input"
          className={cn(
            'border-input bg-background file:bg-background file:text-foreground placeholder:text-muted-foreground selection:bg-default selection:text-default-foreground flex h-9 w-full min-w-0 rounded-md border  px-3 py-1 transition-[color] outline-none file:inline-flex file:h-7 file:border-0  file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 text-sm',
