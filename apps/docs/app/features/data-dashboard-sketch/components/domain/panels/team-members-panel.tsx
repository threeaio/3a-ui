...
import { useTeamData, getTasksByAssignee } from '../../../data-context'
              ...
              <div key={member.id} className="bg-accent/20 rounded-lg overflow-hidden">
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Badge variant="outline">{new Date(member.lastActive).toLocaleDateString('de-DE')}</Badge>
                    ...
                    {memberTasks.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {memberTasks.map((task) => (
                          <div key={task.id} className="flex items-center justify-between bg-background p-3 rounded-md">
