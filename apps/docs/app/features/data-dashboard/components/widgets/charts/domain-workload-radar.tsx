...
export const DomainWorkloadRadar: React.FC = () => {
  const { getDomainWorkloadAnalysis } = useProjectDataContext()

  const data = getDomainWorkloadAnalysis().map(({ domain, hours }) => ({
    domain,
...
export default DomainWorkloadRadar
