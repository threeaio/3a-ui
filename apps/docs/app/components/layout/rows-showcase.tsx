  ...
  return (
    <StyleguideSection title="Row System" subline="Constraints using rows">
      <StyleguideExplanation>
        ...
        <p className="mb-5">
          Please be aware that it is your job to ensure that the content does not epxand the height of the elements. It
          is recommended to use the following <span className="text-foreground">tailwind utility-classes</span> to
